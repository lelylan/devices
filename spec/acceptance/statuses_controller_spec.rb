  ...
  context ".show" do
    ...
    context "when logged in" do
      ...
      context "with range populated" do
        ...
        context "whit intensity to 0.1" do
          before do
            @resource.device_properties.where(uri: Settings.properties.intensity.uri).first.value = '0.1'
            @resource.save 
          end
          context "with intensity pending to false" do
            scenario "should have 'has set intensity' status" do
        ...
        context "with intensity to 9.5" do
          before do
            @resource.device_properties.where(uri: Settings.properties.intensity.uri).first.value = '9.5'
            @resource.save 
          end
        ...
        context "with intensity to 0" do
          before do
            @resource.device_properties.where(uri: Settings.properties.intensity.uri).first.value = '10000.0'
            @resource.save 
          end
